...
namespace TwinGet.Core.Packaging
{
    public static class PackagingErrors
    {
        ...
        public const string FailedToResolveSolutionFile = "Failed to automatically resolve the parent solution file for the provided project file '{Path}'";
        public const string FailedToSavePlcLibrary = "Failed to save the PLC project '{Path}' as library.\n{ExceptionMessage}";
    }
}
