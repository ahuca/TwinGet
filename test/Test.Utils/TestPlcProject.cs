...
internal class TestPlcProject : IPlcProjectMetadata
{
    ...
    public string Name
    {
        get => _data.PropertyGroup.Name;
    }
    public string? Company
    {
        get => _data.PropertyGroup.Company;
    }
    public string Title
    {
    ...
    {
        get => _data.PropertyGroup.ProjectVersion;
    }
    ...
    public TestPlcProject(string path)
    {
        ...
        {
            _data =
                serializer.Deserialize(reader) as PlcProjectData
                ?? throw new InvalidProjectFileFormat(
                    "Failed to parse the PLC project file.",
                    path
                );
        }
    }
